export const articleCards = [{
    id: 1,
    path: require('@/assets/images/ryggsmerter.jpg'),
  ...
  {
    id: 2,
    path: require('@/assets/images/migrene.jpg'),
    category: 'Plager/Lidelser',
  ...
  {
    id: 3,
    path: require('@/assets/images/frozen-sholder.jpg'),
    category: 'Plager/Lidelser',
  ...
  {
    id: 4,
    path: require('@/assets/images/stress.jpg'),
    category: 'Plager/Lidelser',
    title: 'Stress',
  ...
  {
    id: 5,
    path: require('@/assets/images/allergi.jpg'),
    category: 'Plager/Lidelser',
    title: 'Allergi eller intoleranse',
    alt: 'Dame med alleri som er utendørs og tørker seg i nesen med et lommetørkle',
    titleattr: 'Dame med alleri som er utendørs og tørker seg i nesen med et lommetørkle',
    link: '/behandlinger'
  },
  {
    id: 6,
    path: require('@/assets/images/depresjon.jpg'),
    category: 'Plager/Lidelser',
    title: 'Depresjon',
  ...
  {
    id: 7,
    path: require('@/assets/images/astma.jpg'),
    category: 'Plager/Lidelser',
    title: 'Astma',
  ...
  {
    id: 8,
    path: require('@/assets/images/blodtrykk.jpg'),
    category: 'Plager/Lidelser',
  ...
  {
    id: 9,
    path: require('@/assets/images/vond-albue.jpg'),
    category: 'Plager/Lidelser',
  ...
  {
    id: 11,
    path: require('@/assets/images/fertility.jpg'),
    category: 'Plager/Lidelser',
    title: 'Fertilitet',
  ...
  {
    id: 12,
    path: require('@/assets/images/blærebetennelse.jpg'),
    category: 'Plager/Lidelser',
    title: 'Blærekartar',
  ...
  {
    id: 13,
    path: require('@/assets/images/angst.jpg'),
    category: 'Plager/Lidelser',
    title: 'Angst',
  ...
  {
    id: 14,
    path: require('@/assets/images/musearm.jpg'),
    category: 'Plager/Lidelser',
    title: '«Kontorarm/ musearm»',
    alt: 'En hånd masserer den andre over en bærbar maskin og en kalkulator',
    titleattr: 'En hånd masserer den andre over en bærbar maskin og en kalkulator',
    link: '/behandlinger'
  },
  {
    id: 15,
    path: require('@/assets/images/tarmproblemer.jpg'),
    category: 'Plager/Lidelser',
  ...
  {
    id: 16,
    path: require('@/assets/images/graviditet.jpg'),
    category: 'Tilstand',
  ...
  {
    id: 17,
    path: require('@/assets/images/overgangsalder.jpg'),
    category: 'Plager/lidelser',
  ...
  {
    id: 19,
    path: require('@/assets/images/luftveisinfeksjon.jpg'),
    category: 'Plager/lidelser',
  ...
  {
    id: 20,
    path: require('@/assets/images/idrettsskade.jpg'),
    category: 'Plager/lidelser',
    title: 'Idrettskade',
